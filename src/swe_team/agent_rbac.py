...
Guards against unauthorized agent operations (code generation, PR creation,
self-merge). Deny-by-default: if a permission is not explicitly granted, it is denied.
"""
