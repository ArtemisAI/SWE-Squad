...
```bash
gh issue list --repo ArtemisAI/SWE-Squad-DEV --state all --json number,title,state --limit 80
```
...
```bash
gh issue create --repo ArtemisAI/SWE-Squad-DEV --title "..." --body "..." --label "swe-team"
```
