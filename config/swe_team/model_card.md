...
## 2. BASE_LLM Proxy (`https://your-llm-proxy.example.com/v1`)
...
**Do NOT delegate:**
- Proprietary source code (your application, SWE-Squad internals)
...
Hub at `http://localhost:18790` (configurable via `a2a_hub_url` in `swe_team.yaml`).
